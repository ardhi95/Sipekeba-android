...
public class KeyValueArrayAdapter extends ArrayAdapter<KeyValueArrayAdapter.KeyValue> {
     ...
     * @param vaules
     */
    public void setKeyValue(final List<String> keys, final List<String> vaules) {
        ...
        for (int i = 0; i < N; i++) {
            add(new KeyValue(keys.get(i), vaules.get(i)));
        }
    }
     ...
     * @param entryValues
     */
    public void setEntryValues(final List<String> entryValues) {
