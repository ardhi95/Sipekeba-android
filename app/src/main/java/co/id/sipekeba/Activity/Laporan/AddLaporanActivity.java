...
import co.id.sipekeba.Adapter.LaporanAdapter;
...
public class AddLaporanActivity extends AppController {
    public static final String TAG = AddLaporanActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new LaporanAdapter(AddLaporanActivity.this,layananList);
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(AddLaporanActivity.this);
    ...
    private void getDataLayanan(){
        dialogLoading = new ProgressDialog(AddLaporanActivity.this);
